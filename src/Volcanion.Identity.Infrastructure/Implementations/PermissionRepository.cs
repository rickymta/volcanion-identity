...
internal class PermissionRepository : BaseRepository<Permission, ApplicationDbContext>, IPermissionRepository
{
    ...
    public PermissionRepository(ApplicationDbContext context, ILogger<BaseRepository<Permission, ApplicationDbContext>> logger, IHttpContextAccessor httpContextAccessor) : base(context, logger, httpContextAccessor)
    {
    }
}
