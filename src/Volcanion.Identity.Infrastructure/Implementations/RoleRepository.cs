...
internal class RoleRepository : BaseRepository<Role, ApplicationDbContext>, IRoleRepository
{
    ...
    public RoleRepository(ApplicationDbContext context, ILogger<BaseRepository<Role, ApplicationDbContext>> logger, IHttpContextAccessor httpContextAccessor) : base(context, logger, httpContextAccessor)
    {
    }
}
