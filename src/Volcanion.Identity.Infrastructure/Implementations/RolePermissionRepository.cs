...
internal class RolePermissionRepository : BaseRepository<RolePermission, ApplicationDbContext>, IRolePermissionRepository
{
    ...
    public RolePermissionRepository(ApplicationDbContext context, ILogger<BaseRepository<RolePermission, ApplicationDbContext>> logger, IHttpContextAccessor httpContextAccessor) : base(context, logger, httpContextAccessor)
    {
    }
